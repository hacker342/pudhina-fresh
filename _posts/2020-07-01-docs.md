...
`_data/projects.yml`
```yaml
- name: eridan-92.ru # Project name, also used as heading
  ...
  description_less: > # Description shown at all times
    <p>Сайт для клуба тхэквондо.</p> 
  description_more: > # Description shown only when the project card is expanded
    <p>Создан на modX, шаблон и дизайн был взят с интернета.</p> 
  ...
  tags: [modx, сайты] # A list of tags
```
